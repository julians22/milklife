        ...
        <div class="splide__list">
                        ...
                        <div class="flex items-center justify-center h-[600px] 2xl:mt-24 3xl:mt-48">
                            <div class="grid grid-cols-2 grid-rows-2 relative">
                                ...
                                <div class="z-[4] grid-instax row-start-2">
                                    <img class="max-w-[160px] md:max-w-[240px] 2xl:max-w-[300px] 3xl:max-w-[450px] absolute bottom-0 left-0 hover:translate-y-8 hover:-translate-x-4 anim-fade-in" src="{{ asset('img/thumbnail/home/Photo 1.png') }}" alt="">
                                </div>
                                <div class="z-[3] grid-instax row-start-1">
                                    <img class="max-w-[160px] md:max-w-[240px] 2xl:max-w-[300px] 3xl:max-w-[450px] absolute top-0 left-0 hover:-translate-y-8 hover:-translate-x-4 anim-fade-in" src="{{ asset('img/thumbnail/home/Photo 2.png') }}" alt="">
                                </div>
                                <div class="z-[2] grid-instax row-start-2">
                                    <img class="max-w-[160px] md:max-w-[240px] 2xl:max-w-[300px] 3xl:max-w-[450px] absolute right-0 bottom-0 hover:translate-y-8 hover:translate-x-4 anim-fade-in" src="{{ asset('img/thumbnail/home/Photo 3.png') }}" alt="">
                                </div>
                                <div class="z-[1] grid-instax row-start-1">
                                    <img class="max-w-[160px] md:max-w-[240px] 2xl:max-w-[300px] 3xl:max-w-[450px] absolute right-0 top-0 hover:-translate-y-8 hover:translate-x-4 anim-fade-in" src="{{ asset('img/thumbnail/home/Photo 4.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="article-section splide__slide" style="background-image: url('{{ asset('img/bg/orangebg.jpg') }}')" data-splide-hash="artikel">
                ...
                <div class="article-content h-full">
                    ...
                    <div class="max-w-4xl lg:max-w-5xl 2xl:max-w-7xl 3xl:max-w-screen-2xl mx-auto flex flex-col justify-center mt-12 md:mt-32 2xl:mt-40 3xl:mt-48">
            ...
            <section class="explore-section splide__slide" style="background-image: url('{{ asset('img/bg/blue.jpg') }}')" data-splide-hash="explore">
                ...
                <div class="absolute top-0 left-0 md:w-40 w-6">
                    <img src="{{ asset('img/doodle/orange_bottom_rdoodle.png') }}" alt="" class="rotate-180 w-full">
                </div>
                {{-- bottom right doodle --}}
...
@push('after-scripts')
    <script>
        document.addEventListener( 'DOMContentLoaded', function() {
            ...
            const pageSplide = new Splide( '#page-splide' ,{
                perPage: 1,
                speed: 1000,
                pagination: false,
                arrows: false,
