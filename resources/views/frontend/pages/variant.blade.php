...
@section('content')
    <div class="variant-section page flex h-screen overflow-x-hidden bg-milklife-blue-banner">
        ...
        <div class="absolute inset-x-0 bottom-0 z-0 h-56 2xl:h-[200px] bg-milklife-blue-banner-lighter"></div>
        ...
        <div class="variant-content z-0 mt-auto flex h-full w-full flex-col items-stretch justify-end overflow-hidden md:gap-y-0 gap-y-20">
            <div class="title text-center font-geologica font-bold tracking-widest text-4xl text-white drop-shadow-md 2xl:text-5xl">Ragam Rasa
                MilkLife
